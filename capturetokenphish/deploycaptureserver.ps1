...
Write-Output "az vm create --resource-group $ResourceGroup --name webinar --image Ubuntu22.04 --public-ip-sku Standard --public-ip-address-dns-name $vmPublicDNSName --admin-username azureuser --generate-ssh-keys
az vm create --resource-group $ResourceGroup --name $vmName --image Ubuntu22.04 --public-ip-sku Standard --public-ip-address-dns-name $vmPublicDNSName --admin-username azureuser --generate-ssh-keys
Start-Sleep -Seconds 5
